var paper = Raphael(0, 0, 1000, 700);
...
var telerikSeenFromLeft = paper.image("telerik-left.png", 100, 100, 250, 210);
var telerikSeenFromRight = paper.image("telerik-right.png", 650, 100, 250, 210);
...
var sensei = paper.image("super_ninja_for_frame.png", 400, 50, 100, 90);
var shurikenOne = paper.image("shuriken.png", 490, 70, 40, 40);
shurikenOne.attr({ opacity: 0.2 });
var shurikenTwo = paper.image("shuriken.png", 520, 90, 40, 40);
shurikenTwo.attr({ opacity: 0.4 });
var shurikenAnimate = paper.image("shuriken.png", 550, 110, 40, 40);
...
var reverse = false;
//var opa = paper.rect(250, 250, 50, 50).animate({ transform: "r-720,220,200" }, 50000);
var maskedHeadLeft = paper.image("headone.png", 250, 250, 50, 50).animate({ transform: "r-7200,220,200" }, 500000);
maskedHeadLeft.attr({ opacity: 0.5 });

var maskedHeadRight = paper.image("headone.png", 770, 250, 50, 50).animate({ transform: "r7200,770,200" }, 500000);
maskedHeadRight.attr({ opacity: 0.5 });

var tvSet = paper.image("tv.png", 350, 360, 300, 190);
var tvAnimation = paper.image("animation.gif", 368, 377, 265, 133);
