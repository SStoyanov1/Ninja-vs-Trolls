...
function generateEnemy() {
    return new Character(game.field.getWidth(), game.getBottom(), game.enemieSprite, heroAnimations(), game.defaultEnemieHealth, game.heroWidth, game.mainLayer, game.field, game.frameSpeed)
}
